...
const ProductCardSkeleton = () => {
  return (
    <div className="flex w-[88vw] max-w-[22rem] flex-col overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-card animate-pulse sm:w-full sm:max-w-none">
