  ...
  return (
    <div className="relative w-full group">
      <input
        ...
        type={type}
        className={cn(
          "peer flex h-14 w-full rounded-xl border border-border/80 bg-[var(--surface-contrast)] px-4 pt-5 pb-1 text-base text-foreground shadow-xs ring-offset-background transition-all duration-200",
      ...
      <label
        ...
        className={cn(
          ...
          "peer-focus:top-3 peer-focus:text-xs peer-focus:text-primary-600 dark:peer-focus:text-primary-400",
          isLabelFloating && "top-3 text-xs text-primary-600 dark:text-primary-400",
          !isLabelFloating && "top-1/2 text-base",
          error && "text-red-500 peer-focus:text-red-500 dark:text-red-400",
          success && "text-green-500 peer-focus:text-green-500 dark:text-green-400",
